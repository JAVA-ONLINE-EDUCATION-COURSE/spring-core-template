...
public class SpringCoreTemplate {
	public static void main(String[] args) {
		...
		Item item1 = new Item(1, "Pen", 10, context.getBean("colorFactory", Color.class));
		Item item2 = new Item(2, "Book", 30, context.getBean("colorFactory", Color.class));
		Item item3 = new Item(3, "Notebook", 17, context.getBean("colorFactory", Color.class));
